...
import getBaseURL from "@/app/actions/common/getBaseURL";
...
export default function Page() {
  ...
  return (
    <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div onClick={()=>router.back()} className="w-full flex justify-center min-h-screen flex-grow items-center">
        <div onClick={(e)=>e.stopPropagation()} className="bg-white rounded-xl shadow-2xl w-96 p-6 mt-12 shadow-black/50">
